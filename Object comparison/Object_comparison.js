...
if ({ a: 1 } === { a: 1 }) {//false
    ...
    because they look the same and they are stored in two differnt places
  ...
  console.log("Wednesday");
     ...
     /*why would this be false?
     they are two differnt objects with differnt names
...
// you can check if there are the same type (using the typeof command)
